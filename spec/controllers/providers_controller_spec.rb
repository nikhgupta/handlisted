...
#     { "name" => "Provider X", priority_service_name: "PSX" }
#   }
...
#     context "with valid params" do
#       let(:new_attributes) {
#         { "name" => "Provider Z", priority_service_name: "PSZ" }
#       }
...
#         provider.reload
#         expect(provider.name).to eq("Provider Z")
#         expect(provider.priority_service_name).to eq("PSZ")
#       end
