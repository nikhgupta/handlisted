...
RSpec.describe UsersController, type: :controller do
  ...
  describe "PUT #update" do
    ...
    context "with valid params" do
      it "updates the requested user without password and redirects to edit profile page" do
      ...
      it "updates the requested user email without password and redirects to edit profile page" do
        new_attributes = { email: "test2@example.com" }
        put :update, {:id => @user.to_param, :user => new_attributes}, valid_session
        @user.reload
        expect(@user.email).to eq("test@example.com")
        expect(@user.unconfirmed_email).to eq("test2@example.com")
        expect(response).to redirect_to(edit_profile_path)
      end
